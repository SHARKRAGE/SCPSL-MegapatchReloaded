...
#region Debug UI
        ...
        protected virtual void OnGUI()
        {
            ...
            _guiBuilder.AppendFormat(" Graphics device: {0}\n", SystemInfo.graphicsDeviceName);
    ...
    #if TND_FRAMEGEN
            _guiBuilder.AppendFormat(" Frame Generation: {0}\n", FrameGen.FrameGenManager.IsFrameGenEnabled ? "Enabled" : "Disabled");
            _guiBuilder.AppendFormat(" Active FG provider: {0}\n", FrameGen.FrameGenManager.ActiveProvider?.DisplayName ?? "None");
    #endif
