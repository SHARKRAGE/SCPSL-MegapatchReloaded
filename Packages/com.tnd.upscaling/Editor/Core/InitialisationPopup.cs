...
namespace TND.Upscaling.Framework
{
    ...
    {
        [MenuItem("Window/The Naked Dev/Upscaling Documentation")]
        ...
        private void OnGUI()
        {
            EditorVisuals.GenerateHeader(UpscalerControllerEditor.onlineDocumentation);
            ...
            {
                Application.OpenURL(UpscalerControllerEditor.onlineDocumentation);
            }
            ...
            EditorGUILayout.HelpBox("If you want to reopen this window, you can find it under Window > The Naked Dev > Upscaling Documentation.", MessageType.None);
